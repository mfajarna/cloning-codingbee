...
/**
 * Privacy Subsystem implementation for enrol_xendit.
 *
...
namespace enrol_xendit\privacy;
...
/**
 * Privacy Subsystem for enrol_xendit implementing null_provider.
 *
 * @copyright  2020 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
    ...
    \core_payment\privacy\consumer_provider
{
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        $subcontext = [
            get_string('pluginname', 'enrol_xendit'),
        ];
