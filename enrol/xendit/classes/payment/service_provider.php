...
/**
 * Payment subsystem callback implementation for enrol_xendit.
 *
...
namespace enrol_xendit\payment;
...
class service_provider implements \core_payment\local\callback\service_provider {
    ...
    public static function deliver_order(string $paymentarea, int $instanceid, int $paymentid, int $userid): bool {
        ...
        $instance = $DB->get_record('enrol', ['enrol' => 'xendit', 'id' => $instanceid], '*', MUST_EXIST);
