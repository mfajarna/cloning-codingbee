...
* Rename the cloudswyft/ folder to the name of your module (eg "widget").
...
all the instances of the string "cloudswyft" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/cloudswyft/widget/g' {} \;

* Rename the file lang/en/cloudswyft.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_cloudswyft.php
...
and you should find that this cloudswyft has been added to the list of
installed modules.
