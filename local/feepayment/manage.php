...
$PAGE->set_url('/local/feepayment/manage.php');
$PAGE->set_context(context_system::instance());

$PAGE->set_title('feepayment List');
$PAGE->set_heading('feepayment List');
...
// if ($username == 'admin' or $username == 'dede_rmg' or $username == 'Admin_1'){
    ...
    $feelist = $DB->get_records('local_feepayment');
...
//     'homeurl'  => new moodle_url('/local/feepayment/manage.php'),
//     'today' =>  $created,
// ];
...
echo $OUTPUT->render_from_template('local_feepayment/manage',$templatecontext);
