 ...
 class review_form extends moodleform
{
    ...
    public function definition()
    {
        ...
        // $note = $mform->addElement('textarea', 'activity', get_string('activity', 'local_feepayment'), 'wrap="virtual" rows="20" cols="50"');
        // $note->freeze();
        $mform->addElement('textarea', 'activity', get_string('activity', 'local_feepayment'), 'wrap="virtual" rows="20" cols="50"');
        $mform->setType('activity', PARAM_TEXT);
        $mform->setDefault('activity', $mform);
        ...
        $select = $mform->addElement('select','approvalstatus', get_string('approvalstatus','local_feepayment'), $options);
