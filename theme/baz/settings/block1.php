...
$page = new admin_settingpage('theme_baz_block1', get_string('settingsblock1', 'theme_baz'));
          ...
          for ($sliderindex = 1; $sliderindex <= $slidercount; $sliderindex++) {
                    ...
                    $setting = new admin_setting_heading($name, '<span class="rui-admin-no">'. $sliderindex . '</span>'. $heading, format_text(get_string('hblock1slide_desc', 'theme_baz'), FORMAT_MARKDOWN));
                    $page->add($setting);
                    ...
                    <div class="rui-hero-btns d-inline-flex flex-wrap hideforloggedin">
                        <a href="https://demo.rosea.io/baz/1/login/index.php" class="btn btn-lg btn-primary">Sign up</a>
                    </div>';
