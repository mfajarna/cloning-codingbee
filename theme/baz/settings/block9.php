...
$page = new admin_settingpage('theme_baz_block9', get_string('settingsblock9', 'theme_baz'));

          $name = 'theme_baz/displayblock9';
          $title = get_string('turnon', 'theme_baz');
          $description = get_string('displayblock9_desc', 'theme_baz');
          $default = 1;
          $setting = new admin_setting_configcheckbox($name, $title, $description, $default);
          $page->add($setting);

          $name = 'theme_baz/displayhrblock9';
          ...
          $name = 'theme_baz/block9introtitle';
          ...
          $name = 'theme_baz/block9introcontent';
          ...
          $name = 'theme_baz/block9htmlcontent';
          $title = get_string('blockhtmlcontent', 'theme_baz');
          $description = get_string('blockhtmlcontent_desc', 'theme_baz');
          $default = '<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 mx-lg-3">
          ...
          $name = 'theme_baz/block9footercontent';
