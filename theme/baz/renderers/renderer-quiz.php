...
class theme_baz_mod_quiz_renderer extends mod_quiz_renderer {
    /**
     * Outputs a box.
     *
     ...
     */
    public function baz_box($contents, $classes = 'generalbox', $id = null, $attributes = array()) {
        return $this->baz_box_start($classes, $id, $attributes) . $contents . $this->baz_box_end();
    }
     ...
     * @return string the HTML to output.
     */
    public function baz_box_start($classes = 'generalbox', $id = null, $attributes = array()) {
    ...
    public function view_information($quiz, $cm, $context, $messages) {
        ...
        if ($messages) {
            $output .= html_writer::tag('div', $this->access_messages($messages), array('class' => 'rui-quizinfo'));
        }
    ...
    public function view_result_info($quiz, $context, $cm, $viewobj) {
        ...
        if ($resultinfo) {
            $output .= $this->baz_box($resultinfo, 'generalbox', 'rui-feedback');
        }
        return $output;
    }
    ...
    public function view_page($course, $quiz, $cm, $context, $viewobj) {
        ...
        $output .= html_writer::div($this->view_page_buttons($viewobj), 'rui-quizattempt');
        return $output;
    }
...
class theme_baz_core_question_renderer extends core_question_renderer {
    /**
...
class theme_baz_qtype_multichoice_single_renderer extends qtype_multichoice_single_renderer  {
