...
class theme_settings {
  ...
  public function global_settings() {
    ...
    $templatecontext = [];
    $elements = [
      'topbarhamburgermenu', 'googlefonturl', 'seothemecolor', 'themeauthor', 'logocontainer', 'displaycustomalert', 'closecustomalert'
    ];
  ...
  public function footer_settings() {
    ...
    $elements = [
      'customalert', 'darkmodetheme', 'showfooterbuttons'
    ];
