...
class html_renderer extends \plugin_renderer_base {
    ...
    protected function image_header($fixednavbar = false) {
        ...
        foreach ($images as $image) {
            if (!empty($settings->$image)) {
                ...
                if ($CFG->branch >= 33) {
                    $template->$image = $this->image_url($image, 'theme_baz');
                } else {
                    $template->$image = $this->pix_url($image, 'theme_baz');
                }
            }
        }
        ...
        return $this->render_from_template('theme_baz/imageheading', $template);
    }
    ...
    protected function navigation_menu($fixednavbar = false) {
        ...
        return $this->render_from_template('theme_baz/navigation', $template);
    }
    ...
    public function squared_socialicons() {
        ...
        return $this->render_from_template('theme_baz/socialicons', $template);
    }
    ...
    public function languagemenu() {
        ...
        if ($haslangmenu) {
            ...
            return $this->render_from_template('theme_baz/language', $langmenu);
        }
    }
    ...
    public function footer() {
        ...
        return $this->render_from_template('theme_baz/footer', $template);
    }
